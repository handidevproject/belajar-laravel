  <nav @keydown.escape.window="mobileOpen = false" class="bg-gray-800 dark:bg-gray-800/50" x-data="{ mobileOpen: false }">
          ...
          <div class="flex h-16 items-center justify-between">
              ...
              <div class="hidden md:block">
                  <div class="ml-4 flex items-center md:ml-6">
                      ...
                      <!-- Profile dropdown -->
                      <div @keydown.escape.window="profileOpen = false" class="relative ml-3" x-data="{ profileOpen: false }">
                          <button :aria-expanded="profileOpen" @click="profileOpen = !profileOpen" aria-haspopup="true"
                              class="relative flex max-w-xs items-center rounded-full focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
                              type="button">
                              <span class="absolute -inset-1.5"></span>
                              <span class="sr-only">Open user menu</span>
                              <img alt="" class="size-8 rounded-full outline -outline-offset-1 outline-white/10"
              ...
              <div class="-mr-2 flex md:hidden">
                  <!-- Mobile menu button -->
                  <button :aria-expanded="mobileOpen" @click="mobileOpen = !mobileOpen" aria-controls="mobile-menu"
      ...
      <div class="md:hidden" id="mobile-menu" x-cloak x-show="mobileOpen" x-transition>
          <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
              <!-- Current: "bg-gray-950/50 text-white", Default: "text-gray-300 hover:bg-white/5 hover:text-white" -->
              <a aria-current="page" class="block rounded-md bg-gray-950/50 px-3 py-2 text-base font-medium text-white"
                  href="/">Home</a>
